...
class ASCVD:
    ...
    # The following methods could all be embedded in the above. They were separated and made protected
    #  for testing individual values and matched with values from Table A in the paper
